...
<div class="card card-primary">
            ...
            <div class="form-group">
                <label for="inputName">Số thứ tự tài khoản</label>
              ...
              <div class="form-group">
                <label for="inputStatus">Tên người dùng</label>
                <input type="text" id="inputName" class="form-control" value="">
              </div>
              ...
              <button type="button" class="btn btn-outline-danger">Thêm tài khoản</button>
            </div>
            <!-- /.card-body -->
          </div>